<!-- Source: https://platform.claude.com/docs/en/agent-sdk/hosting | Last updated: 2025-01-24 -->
...
- **Modal Sandbox** - [demo implementation](https://modal.com/docs/examples/claude-slack-gif-creator)
...
Best for proactive agents that take action without the user's input, agents that serve content or agents that process high amounts of messages.
...
- High-Frequency Chat Bots: Handles continuous message streams
...
Best for agents that must collaborate closely together.
...
This is likely provider dependent. Tune the timeout based on how frequent you think user response might be.
